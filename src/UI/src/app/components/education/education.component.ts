                ...
                <div class="flex items-start gap-4">
                  <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-[var(--theme-primary)] to-[var(--theme-accent)] flex items-center justify-center flex-shrink-0 text-white group-hover:scale-110 transition-transform duration-300">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" [attr.d]="getIconSvg(cert.icon)"></path>
                    </svg>
                  </div>
                  <div class="flex-1">
        ...
        <div class="mt-20 grid grid-cols-2 md:grid-cols-4 gap-6">
          <div class="text-center group">
            <div class="bg-[var(--theme-surface)]/30 backdrop-blur-sm rounded-2xl p-6 border border-[var(--theme-border)]/20 hover:border-[var(--theme-primary)]/50 transition-all duration-500 hover:transform hover:scale-105">
              ...
              <div class="text-[var(--theme-text-secondary)] font-medium">Certifications</div>
            </div>
          </div>
          <div class="text-center group">
            <div class="bg-[var(--theme-surface)]/30 backdrop-blur-sm rounded-2xl p-6 border border-[var(--theme-border)]/20 hover:border-[var(--theme-primary)]/50 transition-all duration-500 hover:transform hover:scale-105">
              ...
              <div class="text-[var(--theme-text-secondary)] font-medium">Degrees Earned</div>
            </div>
          </div>
          <div class="text-center group">
            <div class="bg-[var(--theme-surface)]/30 backdrop-blur-sm rounded-2xl p-6 border border-[var(--theme-border)]/20 hover:border-[var(--theme-primary)]/50 transition-all duration-500 hover:transform hover:scale-105">
              ...
              <div class="text-[var(--theme-text-secondary)] font-medium">Years of Study</div>
            </div>
          </div>
          <div class="text-center group">
            <div class="bg-[var(--theme-surface)]/30 backdrop-blur-sm rounded-2xl p-6 border border-[var(--theme-border)]/20 hover:border-[var(--theme-primary)]/50 transition-all duration-500 hover:transform hover:scale-105">
              ...
              <div class="text-[var(--theme-text-secondary)] font-medium">Class Ranking</div>
            </div>
          </div>
        </div>
      </div>
